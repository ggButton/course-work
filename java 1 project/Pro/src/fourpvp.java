...
//    private List<Dot> dots = new ArrayList<>();
    ...
    protected Button reset=new Button(150, 656, 130,40,"Again");
    ...
    public fourpvp(int canvasWidth, int canvasHeight, boolean TF) {
    ...
    public void paint(String name) {
        ...
        StdDraw.textLeft(315, 700, name1+":"+a);
        StdDraw.textRight(655, 700, name2+":"+b);
...
//      dots.forEach(Dot::paint);
        if(isEnd()){
            ...
            StdDraw.picture(400,400,"1.jpg",800,800);
            home.paint();
            reset.paint();
    ...
    public static void main(String[] args) {
        fourpvp game = new fourpvp(800, 800, true);
        while (true) {
            game.update();
            game.paint("1.jpg");
            try {
