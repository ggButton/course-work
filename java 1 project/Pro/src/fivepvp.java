...
//    private List<Dot> dots = new ArrayList<>();
    ...
    protected Button reset=new Button(150, 650, 130,40,"Again");
    protected Button home=new Button(150, 750, 130,40,"Home");
    ...
    public fivepvp(int canvasWidth, int canvasHeight, boolean TF) {
    ...
    public void paint(String name) {
        ...
        StdDraw.textLeft(274, 700, name1+":"+a);
        StdDraw.textRight(652, 700, name2+":"+b);
        ...
        if(!isEnd()){
            ...
            if(yourTurn){
                ...
                StdDraw.textLeft(150, 50, "It's your turn!");
            }else{
                StdDraw.setPenColor(Color.BLUE);
                StdDraw.textLeft(150,50,"Please wait...");
            }
        }
...
//      dots.forEach(Dot::paint);
        if(isEnd()){
            StdDraw.picture(400,400,"2.jpg",800,800);
            home.paint();
            reset.paint();
    ...
    public static void main(String[] args) {
        fivepvp game = new fivepvp(800, 800, true);
        while (true) {
            game.update();
            game.paint("2.jpg");
            try {
